...
if (typeof SpeechRecognition === "undefined") {
  ...
  recognition.onresult = event => {
    ...
    if (recognitionResult.isFinal) {
      ...
      p.innerHTML = `<strong>You said:</strong> ${recognitionText} </br><strong>Aditya said:</strong> ${response}`;
...
function readOutLoud(message) {
    ...
    if (maleVoice) {
      ...
      // If no male voice is available, use the default
      console.log("No male voice found. Using the default voice.");
    }
}